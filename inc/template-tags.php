...
function twentyfourteen_post_nav() {
	...
	<nav class="navigation post-navigation" role="navigation">
		<h3 class="screen-reader-text"><?php _e( 'Post navigation', 'twentyfourteen' ); ?></h1>
		<div class="nav-links">
			<?php
			if ( is_attachment() ) :
...
function twentyfourteen_posted_on() {
	...
	printf( '<span class="byline-single">By <span class="author vcard"><a class="url fn n" href="%4$s" rel="author">%5$s</a></span></span><span class="separador">/</span><span class="entry-date-single"><time itemprop="datePublished" content="" rel="bookmark" class="" datetime="%2$s">%3$s</time></span><span class="separador">/</span>',
...
if ( ! function_exists( 'twentyfourteen_posted_on_index' ) ) :
/**
 * Print HTML with meta information for the current post-date/time and author.
 *
 * @since Twenty Fourteen 1.0
 ...
 * @return void
 */
function twentyfourteen_posted_on_index() {
	if ( is_sticky() && is_home() && ! is_paged() ) {
		echo '<span class="featured-post">' . __( 'Sticky', 'twentyfourteen' ) . '</span>';
	}
	...
	printf( '<span class="entry-date">
				<time rel="bookmark" class="" datetime="%2$s">%3$s</time>
			</span>',
		esc_url( get_permalink() ),
		esc_attr( get_the_date( 'c' ) ),
		esc_html( get_the_date() ),
